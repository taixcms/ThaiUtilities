...
/**
 * Class ThaiController
 * */
abstract class ThaiController
{
    public $lastID;
    public $insert_id;
    public $ProjectID;
     ...
     * @return $this
     */
    public function setConfig( $Config): ThaiController
    {
        self::$Config = $Config;
        return $this;
    }
     ...
     * @return $this
     */
    public function setSqlType(string $sqlType): ThaiController
    {
     ...
     * @return $this
     */
    public function setIsAdmin(bool $isAdmin): ThaiController
    {
    ...
    public function setEntityName(string $EntityName): ThaiController
    {
...
;
     ...
     * @throws Exception
     */
    public function get(array $param = null, string $key = null): ThaiController
    {
     ...
     * @return $this
     */
    public function init(): ThaiController
    {
        return $this;
    }
     ...
     * @return $this
     */
    public function getPermissionSetting(array $item, string $type): ThaiController
    {
     ...
     * @return $this
     */
    public function setDefaultValue($fiendName, $value): ThaiController
    {
     ...
     * @return $this
     */
    public function setCondition(string $ConditionType, array $value = []): ThaiController
    {
     ...
     * @return $this
     */
    public function getPermission(): ThaiController
    {
     ...
     * @return $this
     */
    public function setCrossAjaxData(string $Key, $CrossAjaxData): ThaiController
    {
     ...
     * @return $this
     */
    public function setCrossAjaxDataDTO(string $Key, $CrossAjaxData): ThaiController
    {
     ...
     * @return $this
     */
    public function setAttachmentsStatus(): ThaiController
    {
     ...
     * @return $this
     */
    public function setAutoSearchDTO(string $Key, int $autoSearch): ThaiController
    {
     ...
     * @return $this
     */
    public function setClassActionDTO(string $Key, string $ClassAction): ThaiController
    {
     ...
     * @return $this
     */
    public function setAutoSearch(int $autoSearch): ThaiController
    {
     ...
     * @return $this
     */
    public function setClassAction(string $ClassAction): ThaiController
    {
     ...
     * @return $this
     */
    public function setHistory(): ThaiController
    {
...
//        return $string;
     ...
     * @throws Exception
     */
    public function setCheckSum(string $Key): ThaiController
    {
     ...
     * @return $this
     */
    public function setCheckSumDTO(string $Key, string $checkSum): ThaiController
    {
     ...
     * @throws Exception
     */
    public function getSkeleton(): ThaiController
    {
     ...
     * @return $this
     */
    public function setSkeleton(string $Key, array $Skeleton): ThaiController
    {
     ...
     * @return $this
     */
    public function setSkeletonField(array $Value): ThaiController
    {
     ...
     * @return $this
     */
    public function setDefaultFieldType(array $fieldInfo): ThaiController
    {
     ...
     * @return $this
     */
    public function setMemcache_obj(object $memcache_obj): ThaiController
    {
     ...
     * @return $this
     */
    public function mergeParam(object $thisClass): ThaiController
    {
     ...
     * @return $this
     */
    public function setConditionToDataObject(array $item = []): ThaiController
    {
     ...
     * @return $this
     */
    public function setLang(string $lang): ThaiController
    {
        $this->Lang = $lang;
        return $this;
    }
     ...
     * @return $this
     */
    public function setNameDataBase(string $database): ThaiController
    {
     ...
     * @return $this
     */
    public function setSelectCurr(string $SelectCurr): ThaiController
    {
     ...
     * @return $this
     */
    public function setAuthHost(string $AuthHost): ThaiController
    {
     ...
     * @return $this
     */
    public function setIsLogged(bool $isLogged): ThaiController
    {
     ...
     * @return $this
     */
    public function setPageSimpleURL(string $PageSimpleURL): ThaiController
    {
     ...
     * @return $this
     */
    public function AddExcludeKey(string $ExcludeKey): ThaiController
    {
     ...
     * @return $this
     */
    public function unsetExcludeKey(string $ExcludeKey): ThaiController
    {
     ...
     * @return $this
     */
    public function setSqlCount(string $sqlCount): ThaiController
    {
     ...
     * @return $this
     */
    public function setSortOrder(string $sortOrder): ThaiController
    {
     ...
     * @return $this
     */
    public function setSortOrderType(string $sortOrderType): ThaiController
    {
     ...
     * @return $this
     */
    public function setSortOrderDTO(string $Key, string $sortOrder): ThaiController
    {
     ...
     * @return $this
     */
    public function setDefaultFieldTypeDTO(string $Key, array $DefaultFieldType): ThaiController
    {
     ...
     * @return $this
     */
    public function setSortOrderFieldName(string $sortOrderFieldName): ThaiController
    {
     ...
     * @throws Exception
     */
    public function getListByUser(string $key = null): ThaiController
    {
        if (empty($this->getLimit()[$this->getTableName()])) {
            $this->setLimit(10);
        }
    ...
    /**
     * @param int $id
     * @return ThaiController
     */
    public function setIDs(int $id): ThaiController
    {
     ...
     * @throws Exception
     */
    public function getListToPermission(string $key = null): ThaiController
    {
        $Permission = $this->checkPermission($this->getUser($this->getUserId()), 'view');
        if (!$Permission) {
            $this->setData('error', array_merge($this->getData('error'), [[
     ...
     * @throws Exception
     */
    public function getList(string $key = null): ThaiController
    {
        $Permission = $this->checkPermission($this->getUser($this->getUserId()), 'view');
        if (!$Permission) {
            $this->setData('error', array_merge($this->getData('error'), [[
     ...
     * @throws Exception
     */
    public function getItemsByField(string $FieldName, string $FieldValue, string $key = NULL): ThaiController
    {
        if ($this->Connect) {
     ...
     * @throws Exception
     */
    public function getItemByField(string $FieldName, string $FieldValue, string $key = NULL): ThaiController
    {
        if ($this->Connect) {
            $sqlText = "SELECT * FROM " . $this->getTableNameWhere() . " where " . $FieldName . " = '" . $FieldValue . "'";
            $this->setSqlCount(str_replace($this->getSqlType(), 'COUNT(*)', $sqlText));
     ...
     * @throws Exception
     */
    public function getItemsByIDs(array $idList, string $key = NULL): ThaiController
    {
        if ($this->Connect) {
     ...
     * @throws Exception
     */
    public function getItemByID($id, string $key = NULL): ThaiController
    {
        if ((int)$id <= 0) {
            $this->setData('error', array_merge($this->getData('error'), [[
                'method' => 'getItemByID',
     ...
     * @throws Exception
     */
    public function ItemByID($id, string $key = NULL): ThaiController
    {
     ...
     * @throws Exception
     */
    public function getItemByUserID(int $UserID, string $key = NULL): ThaiController
    {
        if ($UserID <= 0) {
            $this->setData('error', array_merge($this->getData('error'), [[
     ...
     * @throws Exception
     */
    public function ItemByUserID($UserID, string $key = NULL): ThaiController
    {
        $CacheAdapter = $this->getConfig()->getCacheAdapterRedis();
     ...
     * @throws Exception
     */
    public function getItemsByUserID(int $UserID, string $key = NULL): ThaiController
    {
        if ($this->Connect) {
     ...
     * @throws Exception
     */
    public function getItemsByUserIDs(array $idList, string $key = NULL): ThaiController
    {
        if ($this->Connect) {
     ...
     * @throws Exception
     */
    public function getListAllNotMy(string $key = null): ThaiController
    {
     ...
     * @throws Exception
     */
    public function getListAll(string $key = null): ThaiController
    {
     ...
     * @return $this
     */
    public function IsLogged(): ThaiController
    {
...
//            }
     ...
     * @return $this
     */
    public function IsLoggedAjax(): ThaiController
    {
        if (!$this->isLogged && (int)$this->getUserId() <= 0) {
            $this->addData('error', [
                'method' => 'IsLoggedAjax',
     ...
     * @return $this
     */
    public function addData(string $key, ?array $Data): ThaiController
    {
        if (empty($key)) {
     ...
     * @return $this
     */
    public function setDataRequest(string $Key, $Request): ThaiController
    {
     ...
     * @return $this
     */
    public function setLimit(int $Limit): ThaiController
    {
     ...
     * @return $this
     */
    public function cachingTime(int $memcache_time): ThaiController
    {
     ...
     * @return $this
     */
    public function setLimitDTO(string $Key, int $Limit): ThaiController
    {
     ...
     * @return $this
     */
    public function setOffsetDTO(string $Key, int $Offset): ThaiController
    {
     ...
     * @return $this
     */
    public function setConditionDTO(string $Key, array $array = null): ThaiController
    {
     ...
     * @return $this
     */
    public function setCountSelect(string $Key, int $CountSelect): ThaiController
    {
     ...
     * @return $this
     */
    public function setCountSelectResult(int $CountSelectResult): ThaiController
    {
     ...
     * @return $this
     */
    public function setCountSelectResultDTO(string $key, int $CountSelectResult): ThaiController
    {
     ...
     * @return $this
     */
    public function getCount(): ThaiController
    {
     ...
     * @return $this
     */
    public function setOffset(int $Offset): ThaiController
    {
     ...
     * @return $this
     */
    public function setCountPage(int $countPage): ThaiController
    {
     ...
     * @return $this
     */
    public function setCountPageDTO(string $Key, int $countPage = null): ThaiController
    {
     ...
     * @return $this
     */
    public function setNumberPage(int $numberPage): ThaiController
    {
     ...
     * @return $this
     */
    public function setNumberPageDTO(string $Key, array $numberPageArr): ThaiController
    {
     ...
     * @return $this
     */
    public function setCurrentPage(int $currentPage): ThaiController
    {
     ...
     * @return $this
     */
    public function setCurrentPageDTO(string $Key, int $currentPage): ThaiController
    {
     ...
     * @return $this
     */
    public function setRequest(array $Request): ThaiController
    {
     ...
     * @return $this
     */
    public function Action(): ThaiController
    {
        return $this;
    }
     ...
     * @return $this
     */
    public function AttachmentsRemove(int $id): ThaiController
    {
     ...
     * @return $this
     */
    public function setExtraData(string $Key, $ExtraData): ThaiController
    {
        if (empty($this->ExtraData[$Key])) {
     ...
     * @return $this
     */
    public function setExtraDataArray(string $Key, string $Key2, $ExtraData): ThaiController
    {
        if (empty($this->ExtraData[$Key])) {
            $this->ExtraData[$Key] = [];
        }
     ...
     * @return $this
     */
    public function setDataObject(string $Key, array $DataSet): ThaiController
    {
     ...
     * @return $this
     */
    public function setData(string $Key, ?array $Data): ThaiController
    {
        $this->Data[$Key] = $Data;
        return $this;
    }
     ...
     * @return $this
     */
    public function setValueWhere(?string $valueWhere): ThaiController
    {
     ...
     * @return $this
     */
    public function setFieldsWhere(string $fieldsWhere): ThaiController
    {
     ...
     * @return $this
     */
    public function setTableNameWhere(string $TableNameWhere): ThaiController
    {
     ...
     * @return $this
     */
    public function setFieldsId(string $fieldsId): ThaiController
    {
     ...
     * @return $this
     */
    public function setUserid(int $userid): ThaiController
    {
        $this->User_Id = $userid;
        return $this;
    }
     ...
     * @return $this
     */
    public function Debug(int $debug = 2): ThaiController
    {
        $this->debug = $debug;
        return $this;
    }
     ...
     * @return $this
     */
    public function setProjectID(int $ProjectID): ThaiController
    {
     ...
     * @throws Exception
     */
    public function extractedGetRow(array $getRequest, string $dopSqlText, ?string $key): ThaiController
    {
